...
<body class="<?php echo Language::getDirectionClass(); ?>">
    <div class="d-flex flex-column vh-100">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarUserDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <span class="ms-1"><?php 
                                                   ...
                                                   echo htmlspecialchars(Session::get('user_name', 'User')); 
                                                   ?></span>
                            </a>
        ...
        <div class="d-flex flex-grow-1 overflow-hidden">
            ...
            <!-- Main content area -->
            <main class="app-content p-4 flex-grow-1 overflow-y-auto">
                <?php echo $content ?? '<h1>Main Content Area Placeholder</h1><p>Error: Content not loaded.</p>'; ?>
            </main>
        </div>

        <!-- Footer -->
        <footer class="app-footer bg-light border-top p-3 text-center">
